    ...
    <div className="suppliers-stats sap-theme">
      ...
      <div className="stats-accordion-header sap-theme">
        ...
        >
          ...
          <span className={`accordion-icon sap-theme ${isExpanded ? 'expanded' : ''}`}>📊</span>
          <span className={`accordion-chevron sap-theme ${isExpanded ? 'expanded' : ''}`}>▼</span>
        </button>
      </div>
                ...
                {Object.entries(stats.byType)
                  ...
                  .map(([type, count]) => (
                    <div key={type} className="breakdown-item sap-theme">
                      <div className="breakdown-label sap-theme">
                        <span className="type-icon sap-theme">{getTypeIcon(type)}</span>
        ...
        <div className="stats-insights">
          ...
          <div className="insights-grid">
            ...
            <div className="insight-item">
              ...
              <div className="insight-value">
                {stats.active / stats.total >= 0.9
                  ? 'Excelente'
                  : stats.active / stats.total >= 0.8
                    ? 'Bueno'
                    : stats.active / stats.total >= 0.7
                      ? 'Regular'
                      : 'Revisar'}
              </div>
            </div>
            ...
            <div className="insight-item">
              ...
              <div className="insight-value">
                {stats.preferred === 0
                  ? 'Ninguno'
                  : stats.preferred / stats.active >= 0.3
                    ? 'Suficientes'
                    : stats.preferred / stats.active >= 0.2
                      ? 'Buenos'
                      : 'Pocos'}
              </div>
            </div>
            ...
            <div className="insight-item">
              ...
              <div className="insight-value">
                {Object.keys(stats.byCategory).length >= 3
                  ? 'Alta'
                  : Object.keys(stats.byCategory).length >= 2
                    ? 'Media'
                    : 'Baja'}
              </div>
            </div>
