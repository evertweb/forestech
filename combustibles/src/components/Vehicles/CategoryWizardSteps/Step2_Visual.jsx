...
const Step2_Visual = ({ formData, updateFormData, errors, isActive }) => {
    ...
    <div className={`wizard-step step-category-visual ${isActive ? 'active' : ''}`}>
      <div className="typeform-layout">
        ...
        <div className="typeform-question">
          <h2>
            🎨 ¡Genial! Ahora dale personalidad a <span className="highlight">{formData.name}</span>
          </h2>
        ...
        <div className="typeform-section">
          ...
          <div className="color-palette">
            {colorOptions.map((option) => (
              ...
              >
                {formData.color === option.color && <span className="color-checkmark">✓</span>}
              </div>
            ))}
          </div>
          {errors.color && (
        ...
        <div className="info-section">
          <div className="info-card">
            ...
            <div className="info-content">
              ...
              <ul>
                <li>
                  <strong>Identificación rápida:</strong> Reconoce categorías de un vistazo
                </li>
                <li>
                  <strong>Interfaz consistente:</strong> Colores uniformes en toda la app
                </li>
                <li>
                  <strong>Reportes visuales:</strong> Gráficos con colores distintivos
                </li>
                <li>
                  <strong>Organización intuitiva:</strong> Agrupa visualmente vehículos similares
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="navigation-hint">
          💡 Tip: Puedes usar las teclas 1-{Math.min(9, iconOptions.length)} para seleccionar iconos
          rápidamente
        </div>
      </div>
    </div>
