...
// URLs predefinidas
<a href={COMMUNICATION_URLS.WHATSAPP_SUPPORT}>Contactar Soporte</a>;

// URLs dinámicas
const customWhatsApp = buildWhatsAppURL('573124559869', 'Necesito ayuda con el inventario');
```
...
- Prefixar constantes por contexto (UI*, MODAL*, etc.)
