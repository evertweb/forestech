...
class InventoryService extends CRUDService {
  ...
  subscribeToInventory(callback) {
    ...
    return this.subscribeToChanges((items, error) => {
      if (error) {
        callback(null, error);
        return;
      }
...
export const updateInventoryItem = (id, data, user) => inventoryService.updateInventory(id, data, user);
...
export const updateStock = (itemId, newStock, user) => inventoryService.updateStock(itemId, newStock, user);
export const getInventoryStats = () => inventoryService.getInventoryStats();
export const batchUpdateInventory = (updates, user) => inventoryService.batchUpdateInventory(updates, user);
