...
class ProductsService extends CRUDService {
  ...
  async updateProductPrice(productId, newPrice, updatedBy = 'system') {
    ...
    const result = await this.updateProduct(productId, {
      price,
...
export const updateProduct = (id, data, updatedBy) => productsService.updateProduct(id, data, updatedBy);
...
export const updateProductPrice = (id, price, updatedBy) => productsService.updateProductPrice(id, price, updatedBy);
export const changeProductStatus = (id, status, updatedBy) => productsService.changeProductStatus(id, status, updatedBy);
export const listenToProducts = (callback, options) => productsService.listenToProducts(callback, options);
