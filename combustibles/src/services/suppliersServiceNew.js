...
export const updateSupplier = (id, data, updatedBy) =>
  suppliersService.updateSupplier(id, data, updatedBy);
export const deleteSupplier = (id) => suppliersService.deleteSupplier(id);
export const getSuppliersByFuelType = (fuelType) =>
  suppliersService.getSuppliersByFuelType(fuelType);
...
export const listenToSuppliers = (callback, options) =>
  suppliersService.listenToSuppliers(callback, options);
