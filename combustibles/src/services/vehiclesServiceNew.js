...
class VehiclesService extends CRUDService {
  ...
  async changeVehicleStatus(vehicleId, newStatus, reason = '', updatedBy = 'system') {
    ...
    const result = await this.updateVehicle(
      vehicleId,
      {
        status: newStatus,
...
export const updateVehicle = (id, data, updatedBy) =>
  vehiclesService.updateVehicle(id, data, updatedBy);
...
export const updateVehicleMetrics = (id, metrics) =>
  vehiclesService.updateVehicleMetrics(id, metrics);
export const changeVehicleStatus = (id, status, reason, updatedBy) =>
  vehiclesService.changeVehicleStatus(id, status, reason, updatedBy);
export const listenToVehicles = (callback, options) =>
  vehiclesService.listenToVehicles(callback, options);
