import{g as Xn,a as h,q as ee,e as te,b as J,c as y,d as Je,i as et,p as Qn,u as Zn,_,f as en,h as tn,j as ei,k as ti,l as ni,S as de,m as ii,F as tt,E as nt,L as ri,n as nn,o as si,r as oi,s as ai,t as ci,v as bt,C as Nt,w as Ct,x as li}from"./firebase-core-DPBV3M-Z.js";import{_ as it}from"./ui-hAo-FJVn.js";import"./vendor-DJG_os-6.js";/**
 * @license
 ...
 */const oo={PHONE:"phone",TOTP:"totp"},ao={FACEBOOK:"facebook.com",GITHUB:"github.com",GOOGLE:"google.com",PASSWORD:"password",PHONE:"phone",TWITTER:"twitter.com"},co={EMAIL_LINK:"emailLink",EMAIL_PASSWORD:"password",FACEBOOK:"facebook.com",GITHUB:"github.com",GOOGLE:"google.com",PHONE:"phone",TWITTER:"twitter.com"},lo={LINK:"link",REAUTHENTICATE:"reauthenticate",SIGN_IN:"signIn"},uo={EMAIL_SIGNIN:"EMAIL_SIGNIN",PASSWORD_RESET:"PASSWORD_RESET",RECOVER_EMAIL:"RECOVER_EMAIL",REVERT_SECOND_FACTOR_ADDITION:"REVERT_SECOND_FACTOR_ADDITION",VERIFY_AND_CHANGE_EMAIL:"VERIFY_AND_CHANGE_EMAIL",VERIFY_EMAIL:"VERIFY_EMAIL"};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mr(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function gr(n){const e=ee(te(n)).link,t=e?ee(te(e)).deep_link_id:null,i=ee(te(n)).deep_link_id;return(i?ee(te(i)).link:null)||i||t||e||n}class me{constructor(e){var t,i,r,s,o,a;const c=ee(te(e)),u=(t=c.apiKey)!==null&&t!==void 0?t:null,d=(i=c.oobCode)!==null&&i!==void 0?i:null,p=mr((r=c.mode)!==null&&r!==void 0?r:null);l(u&&d&&p,"argument-error"),this.apiKey=u,this.operation=p,this.code=d,this.continueUrl=(s=c.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=c.lang)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const t=gr(e);try{return new me(t)}catch{return null}}}function mo(n){return me.parseLink(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _o(n,e){const t=h(n);await De(!0,t,e);const{providerUserInfo:i}=await wi(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),r=bn(i||[]);return t.providerData=t.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function ut(n,e,t=!1){const i=await C(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return A._forOperation(n,"link",i)}async function De(n,e,t){await ae(e);const i=bn(e.providerData),r=n===!1?"provider-already-linked":"no-such-provider";l(i.has(t)===n,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Io(n,e){if(_(n.app))return Promise.reject(E(n));const t=I(n),i=await Tr(t,{token:e,returnSecureToken:!0}),r=await A._fromIdTokenResponse(t,"signIn",i);return await t._updateCurrentUser(r.user),r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ft(n){const e=I(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function vo(n,e,t){const i=I(n),r={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&Le(i,r,t),await H(i,r,"getOobCode",sr,"EMAIL_PASSWORD_PROVIDER")}async function Eo(n,e,t){await kn(h(n),{oobCode:e,newPassword:t}).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&ft(n),i})}async function To(n,e){await nr(h(n),{oobCode:e})}async function wr(n,e){const t=h(n),i=await kn(t,{oobCode:e}),r=i.requestType;switch(l(r,t,"internal-error"),r){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":l(i.newEmail,t,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":l(i.mfaInfo,t,"internal-error");default:l(i.email,t,"internal-error")}let s=null;return i.mfaInfo&&(s=ge._fromServerResponse(I(t),i.mfaInfo)),{data:{email:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.newEmail:i.email)||null,previousEmail:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.email:i.newEmail)||null,multiFactorInfo:s},operation:r}}async function wo(n,e){const{data:t}=await wr(h(n),e);return t.email}async function yo(n,e,t){if(_(n.app))return Promise.reject(E(n));const i=I(n),o=await H(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Pn,"EMAIL_PASSWORD_PROVIDER").catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&ft(n),c}),a=await A._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(a.user),a}function Ao(n,e,t){return _(n.app)?Promise.reject(E(n)):dt(h(n),j.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&ft(n),i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ro(n,e,t){const i=I(n),r={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,a){l(a.handleCodeInApp,i,"argument-error"),a&&Le(i,o,a)}s(r,t),await H(i,r,"getOobCode",or,"EMAIL_PASSWORD_PROVIDER")}function ko(n,e){const t=me.parseLink(e);return t?.operation==="EMAIL_SIGNIN"}async function Po(n,e,t){if(_(n.app))return Promise.reject(E(n));const i=h(n),r=j.credentialWithLink(e,t||oe());return l(r._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),dt(i,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function So(n,e){const t=ot()?oe():"http://localhost",i={identifier:e,continueUri:t},{signinMethods:r}=await yr(h(n),i);return r||[]}async function bo(n,e){const t=h(n),r={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()};e&&Le(t.auth,r,e);const{email:s}=await rr(t.auth,r);s!==n.email&&await n.reload()}async function No(n,e,t){const i=h(n),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await n.getIdToken(),newEmail:e};t&&Le(i.auth,s,t);const{email:o}=await ar(i.auth,s);o!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Co(n,{displayName:e,photoURL:t}){if(e===void 0&&t===void 0)return;const i=h(n),s={idToken:await i.getIdToken(),displayName:e,photoUrl:t,returnSecureToken:!0},o=await C(i,Ar(i.auth,s));i.displayName=o.displayName||null,i.photoURL=o.photoUrl||null;const a=i.providerData.find(({providerId:c})=>c==="password");a&&(a.displayName=i.displayName,a.photoURL=i.photoURL),await i._updateTokensIfNecessary(o)}function Oo(n,e){const t=h(n);return _(t.auth.app)?Promise.reject(E(t.auth)):On(t,e,null)}function Do(n,e){return On(h(n),null,e)}async function On(n,e,t){const{auth:i}=n,s={idToken:await n.getIdToken(),returnSecureToken:!0};e&&(s.email=e),t&&(s.password=t);const o=await C(n,er(i,s));await n._updateTokensIfNecessary(o,!0)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rr(n){var e,t;if(!n)return null;const{providerId:i}=n,r=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},s=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!i&&n?.idToken){const o=(t=(e=Ce(n.idToken))===null||e===void 0?void 0:e.firebase)===null||t===void 0?void 0:t.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new B(s,a)}}if(!i)return null;switch(i){case"facebook.com":return new kr(s,r);case"github.com":return new Pr(s,r);case"google.com":return new Sr(s,r);case"twitter.com":return new br(s,r,n.screenName||null);case"custom":case"anonymous":return new B(s,null);default:return new B(s,i,r)}}class B{constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class Dn extends B{constructor(e,t,i,r){super(e,t,i),this.username=r}}class kr extends B{constructor(e,t){super(e,"facebook.com",t)}}class Pr extends Dn{constructor(e,t){super(e,"github.com",t,typeof t?.login=="string"?t?.login:null)}}class Sr extends B{constructor(e,t){super(e,"google.com",t)}}class br extends Dn{constructor(e,t,i){super(e,"twitter.com",t,i)}}function Lo(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:Rr(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mo(n,e){return h(n).setPersistence(e)}function Uo(n){return An(n)}async function Vo(n,e){return I(n).validatePassword(e)}function Nr(n,e,t,i){return h(n).onIdTokenChanged(e,t,i)}function Cr(n,e,t){return h(n).beforeAuthStateChanged(e,t)}function Fo(n,e,t,i){return h(n).onAuthStateChanged(e,t,i)}function xo(n){h(n).useDeviceLanguage()}function Ho(n,e){return h(n).updateCurrentUser(e)}function Wo(n){return h(n).signOut()}function qo(n,e){return I(n).revokeAccessToken(e)}async function jo(n){return h(n).delete()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ta(n,e,t){return fs(n,e,t)}async function fs(n,e,t){if(_(n.app))return Promise.reject(E(n));const i=I(n);X(n,e,L),await i._initializationPromise;const r=G(i,t);return await Et(r,i),r._openRedirect(i,e,"signInViaRedirect")}function na(n,e,t){return ms(n,e,t)}async function ms(n,e,t){const i=h(n);if(X(i.auth,e,L),_(i.auth.app))return Promise.reject(E(i.auth));await i.auth._initializationPromise;const r=G(i.auth,t);await Et(r,i.auth);const s=await Kn(i);return r._openRedirect(i.auth,e,"reauthViaRedirect",s)}function ia(n,e,t){return gs(n,e,t)}async function gs(n,e,t){const i=h(n);X(i.auth,e,L),await i.auth._initializationPromise;const r=G(i.auth,t);await De(!1,i,e.providerId),await Et(r,i.auth);const s=await Kn(i);return r._openRedirect(i.auth,e,"linkViaRedirect",s)}async function ra(n,e){return await I(n)._initializationPromise,zn(n,e,!1)}async function zn(n,e,t=!1){if(_(n.app))return Promise.reject(E(n));const i=I(n),r=G(i,e),o=await new ds(i,r,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function Kn(n){const e=Ue(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zs=5*60,eo=tn("authIdTokenMaxAge")||Zs;let Zt=null;const to=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>eo)return;const r=t?.token;Zt!==r&&(Zt=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function sa(n=Xn()){const e=en(n,"auth");if(e.isInitialized())return e.getImmediate();const t=Yi(n,{popupRedirectResolver:$s,persistence:[Xr,Fr,Fn]}),i=tn("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(i,location.origin);if(location.origin===s.origin){const o=to(s.toString());Cr(t,o,()=>o(t.currentUser)),Nr(t,a=>o(a))}}const r=ei("auth");return r&&Xi(t,`http://${r}`),t}function no(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}Vi({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=r=>{const s=T("internal-error");s.customData=r,t(s)},i.type="text/javascript",i.charset="UTF-8",no().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Qs("Browser");export{uo as ActionCodeOperation,me as ActionCodeURL,fe as AuthCredential,po as AuthErrorCodes,ce as EmailAuthCredential,j as EmailAuthProvider,U as FacebookAuthProvider,oo as FactorId,F as GithubAuthProvider,V as GoogleAuthProvider,O as OAuthCredential,ye as OAuthProvider,lo as OperationType,q as PhoneAuthCredential,Y as PhoneAuthProvider,Bs as PhoneMultiFactorGenerator,ao as ProviderId,$o as RecaptchaVerifier,Qe as SAMLAuthProvider,co as SignInMethod,Ys as TotpMultiFactorGenerator,wt as TotpSecret,x as TwitterAuthProvider,To as applyActionCode,Cr as beforeAuthStateChanged,Ko as browserCookiePersistence,Fr as browserLocalPersistence,$s as browserPopupRedirectResolver,Fn as browserSessionPersistence,wr as checkActionCode,Eo as confirmPasswordReset,Xi as connectAuthEmulator,yo as createUserWithEmailAndPassword,ho as debugErrorMap,jo as deleteUser,So as fetchSignInMethodsForEmail,Lo as getAdditionalUserInfo,sa as getAuth,fo as getIdToken,yi as getIdTokenResult,Go as getMultiFactorResolver,ra as getRedirectResult,Vt as inMemoryPersistence,Xr as indexedDBLocalPersistence,Yi as initializeAuth,Uo as initializeRecaptchaConfig,ko as isSignInWithEmailLink,vr as linkWithCredential,Yo as linkWithPhoneNumber,ea as linkWithPopup,ia as linkWithRedirect,zo as multiFactor,Fo as onAuthStateChanged,Nr as onIdTokenChanged,mo as parseActionCodeURL,di as prodErrorMap,Er as reauthenticateWithCredential,Jo as reauthenticateWithPhoneNumber,Zo as reauthenticateWithPopup,na as reauthenticateWithRedirect,ki as reload,qo as revokeAccessToken,bo as sendEmailVerification,vo as sendPasswordResetEmail,Ro as sendSignInLinkToEmail,Mo as setPersistence,go as signInAnonymously,dt as signInWithCredential,Io as signInWithCustomToken,Ao as signInWithEmailAndPassword,Po as signInWithEmailLink,Bo as signInWithPhoneNumber,Qo as signInWithPopup,ta as signInWithRedirect,Wo as signOut,_o as unlink,Ho as updateCurrentUser,Oo as updateEmail,Do as updatePassword,Xo as updatePhoneNumber,Co as updateProfile,xo as useDeviceLanguage,Vo as validatePassword,No as verifyBeforeUpdateEmail,wo as verifyPasswordResetCode};
