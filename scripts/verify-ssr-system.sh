...
check_endpoint "/combustibles/movements" "Movements SSR"
check_endpoint "/combustibles/inventory" "Inventory SSR"
check_endpoint "/combustibles/vehicles" "Vehicles SSR"
...
echo "   • /combustibles/movements"
echo "   • /combustibles/inventory"
echo "   • /combustibles/vehicles"
