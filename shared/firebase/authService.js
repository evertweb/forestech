// shared/firebase/authService.js
// Servicio de autenticación compartido entre todas las apps Forestech
import { 
...
export const registerWithEmail = async (email, password, invitationCode = null, appContext = 'general') => {
  try {
